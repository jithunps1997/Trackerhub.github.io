...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $username = $_POST["username"];  // Get the logged-in username from the session
...
<div class="signout-buttons">
        <a href="login.php" class="signout-link">Sign Out</a>
    </div>
    <h2>Contact Us</h2>
...
<script>
    function showAlert() {
        alert("Incident has been created. Issue will be addressed within 24hrs");
    }
</script>
